...
public class TriggeredProcessingUnit extends ProcessingUnit {
	...
	public void actionStartReceived(ActionEvent event)
	{
		this.handleStartEvent(event);
	}
	
	public void actionStopReceived(ActionEvent event)
	{
	...
	public void handleStartEvent(ActionEvent event)
	{
	...
	public void handleStopEvent(ActionEvent event)
	{
	...
	public void loadGesture(String filename) {
		GestureModel g = com.quackware.shake.wiigee.util.FileIO.readFromFile(filename);
		this.classifier.addGestureModel(g);	
	}

	@Override
	public void saveGesture(int id, String filename) {
		com.quackware.shake.wiigee.util.FileIO.writeToFile(this.classifier.getGestureModel(id), filename);
	}
